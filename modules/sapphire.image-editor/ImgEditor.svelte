<script lang="ts">
	...
	import {Field} from "../sapphire.admin";
...
<Field>
	<SelectField bind:value={metadata.crop} options="left,right,center,manual,bottom,top,attention,entropy"/>
</Field>

<ImageFocusEditor {metadata} {file}/>